...
void SetKpKd() {                   //เดินหน้า
  Set_KP_KD(SPD_10, 0.004, 0.04);  //ความเร็ว 10
  Set_KP_KD(SPD_20, 0.005, 0.05);  //ความเร็ว 20
  Set_KP_KD(SPD_30, 0.006, 0.06); //ความเร็ว 30
  Set_KP_KD(SPD_40, 0.007, 0.07); //ความเร็ว 40
  Set_KP_KD(SPD_50, 0.008, 0.08); //ความเร็ว 50
  Set_KP_KD(SPD_60, 0.009, 0.09); //ความเร็ว 60
  Set_KP_KD(SPD_70, 0.010, 0.10); //ความเร็ว 70
  Set_KP_KD(SPD_80, 0.011, 0.11); //ความเร็ว 80
  Set_KP_KD(SPD_90, 0.012, 0.12); //ความเร็ว 90
  Set_KP_KD(SPD_100, 0.013, 0.13); //ความเร็ว 100
}

void SetKpKdBack() {                    //ถอยหลัง
  Set_KP_KD_Back(SPD_10, 0.004, 0.04);  //ความเร็ว 10
  Set_KP_KD_Back(SPD_20, 0.005, 0.05);  //ความเร็ว 20
  Set_KP_KD_Back(SPD_30, 0.006, 0.06); //ความเร็ว 30
  Set_KP_KD_Back(SPD_40, 0.007, 0.07); //ความเร็ว 40
  Set_KP_KD_Back(SPD_50, 0.008, 0.08); //ความเร็ว 50
  Set_KP_KD_Back(SPD_60, 0.009, 0.09); //ความเร็ว 60
  Set_KP_KD_Back(SPD_70, 0.010, 0.10); //ความเร็ว 70
  Set_KP_KD_Back(SPD_80, 0.011, 0.11); //ความเร็ว 80
  Set_KP_KD_Back(SPD_90, 0.012, 0.12); //ความเร็ว 90
  Set_KP_KD_Back(SPD_100, 0.013, 0.13); //ความเร็ว 100
}
