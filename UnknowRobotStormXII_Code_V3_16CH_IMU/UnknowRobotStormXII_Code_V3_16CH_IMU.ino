...
void setup() {
  ...
  //////////// SET LIGHT VALUE ////////////
  RefLineValue(400);          // ค่าในการจับเส้น เซนเซอร์หน้า หลัง  //ถ้าหุ่นยนต์ไม่นับแยก ลดค่าลง 100
  RefCenterLineValue(400);    // ค่าในการจับเส้น เซนเซอร์คู่กลาง    //ถ้าหุ่นยนต์ไม่นับแยก ลดค่าลง 100
  ...
  //////////// SET TURN SPEED /////////////
  TurnSpeedLeft(15, 70, 60);   // ความเร็วเลี้ยวซ้าย
  TurnSpeedRight(70, 15, 60);  // ความเร็วเลี้ยวขวา
  ...
  // SerialServoControl();  //ตั้งค่าเซอร์โวผ่าน serial monitor. 39 38 37  2 1 0
